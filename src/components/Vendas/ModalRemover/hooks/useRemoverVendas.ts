...
export function useRemoverVendas(){
    const queryClient = useQueryClient()
    const putCancelarVendas = useCustomMutation({
        method:"DELETE",
        route:"vendas/deletar"
    })
    

    function FnRemoverVendas({vendaId,handleClose}:{vendaId:number,handleClose:()=>void}){
