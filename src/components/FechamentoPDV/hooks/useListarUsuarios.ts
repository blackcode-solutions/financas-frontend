...
export function useListarUsuarios() {
    const usuarioSelect = useRef(null);
    const [optionsUsuarios, setOptionsUsuarios] = useState([]);
    const [selectedUser, setDelectedUser] = useState(null);
    ...
    return { usuarioSelect, optionsUsuarios, selectedUser, setDelectedUser, handleInputChange };
  }
